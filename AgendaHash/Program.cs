...
Console.WriteLine("Praticando a estrutura de dados do tipo dicionário");

Hashtable contatos = new Hashtable();
...
while (true)
{
    ...
    switch (opcao)
    {
        ...
        case "2":
            ...
            if (contatos.ContainsKey(buscarPorNome))
            {
                Console.WriteLine($"Contato encontrado: {buscarPorNome} - {contatos[buscarPorNome]}");
            }
            else
            {
        ...
        case "3":
            Console.WriteLine("\nLista de Contatos: ");
            foreach (DictionaryEntry  contato in contatos)
